...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # Training parameters
    optimizer = torch.optim.Adam([{'params': model.module.encoder.parameters(), 'weight_decay': args.weight_decay},
    ...
    while epoch < args.num_epochs:
        ...
        for step, sample_batched in enumerate(dataloader.data):
            ...
            lpg8x8, lpg4x4, lpg2x2, reduc1x1, depth_est, feat_all = model(image, focal)

            if args.dataset == 'nyu':
                mask = depth_gt > 0.1
            else:
                mask = depth_gt > 1.0
            loss = silog_criterion.forward(depth_est, lpg2x2, lpg4x4, lpg8x8, depth_gt, mask.to(torch.bool))
            loss.backward()
