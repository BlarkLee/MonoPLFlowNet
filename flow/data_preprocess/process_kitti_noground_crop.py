...
def process_one_frame(idx):
    ...
    #print("valid_pc1", valid_pc1.shape)
    #print(stop)
    ...
    final_mask = np.logical_and(final_mask, not_ground)
    
    #crop to [352, 1216](32 times) to feed into depth network
    pc1 = pc1[:352, :1216, :]
    pc2 = pc2[:352, :1216, :]
    final_mask = final_mask[:352, :1216]
    ...
    np.save(osp.join(truenas_path, 'pc1.npy'), pc1)
    np.save(osp.join(truenas_path, 'pc2.npy'), pc2)
    np.save(osp.join(truenas_path, 'pc_mask.npy'), final_mask)
