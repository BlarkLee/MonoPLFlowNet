...
from evaluation_monopl_flyingthings3d_ablation_expansion import evaluate
...
def main():
    ...
    model = models.__dict__[args.arch]([1, 1280, 384], md=[int(4*(512/256)),4,4,4,4], fac=2.0, 
  exp_unc=False)
    ...
    '''
    model_depth = models.__dict__[args.arch_depth](args)
    model_depth = torch.nn.DataParallel(model_depth).cuda()'''
