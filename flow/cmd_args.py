...
model_names = sorted(name for name in models.__dict__
                     ...
                     and callable(models.__dict__[name])) + ['ICP'] + ['MonoSceneFlow_fly'] + ['MonoSceneFlow_kitti'] + ['MonoSceneFlow_Multi'] + ['ExpansionNet']

dataset_names = sorted(name for name in datasets.__dict__
                       if not name.startswith("__")) + ['KITTI_ablation_expansion']
