...
class BilateralConvFlex(nn.Module):
    ...
    def forward(self, features,
        ...
        if self.do_splat:
            ...
            #print("splatted1", splatted.shape)
            # (B, feat_size, H+1)
            ...
            if self.use_norm:
                ...
                splatted *= norm[:, None, :]
                #print("splatted2", splatted.shape)
        ...
        if self.MAX_SIZE == -1:
            ...
            chunk_size = max(1,
                             min(self.MAX_SIZE // self.num_input // self.filter_size,
                                 max_hash_cnt))
            #print("very important", self.num_input, self.filter_size, self.MAX_SIZE // self.num_input // self.filter_size)
        ...
        #print("feat_blurred", feat_blurred.shape)
