...
class PLSceneNet_shallow(nn.Module):
    def __init__(self, args):
        super(PLSceneNet_shallow, self).__init__()
   
        ### initiate scene dependency
        ...
        self.up_4_to_2 = BilateralConvFlex(self.dim, self.scales_filter_map[0][3],
        ...
        self.coor_4_to_2 = BilateralCorrelationFlex(self.dim,
    ...
    def forward(self, feat0_1, feat0_2, feat0_4, feat1_1, feat1_2, feat1_4, generated_data):  
        ...
        ## level 4 to level 2
        feat0_4 = self.conv4_embed(feat0_4)
        pcl0_4, pcl0_4_to_2 = self.up_4_to_2(torch.cat((generated_data[3]['pc1_el_minus_gr'], feat0_4), dim=1),
                               in_barycentric=None,
                               ...
                               out_barycentric_upsample=generated_data[2]['pc1_barycentric'],
                               out_lattice_offset_upsample=generated_data[2]['pc1_lattice_offset']
                              )

        feat1_4 = self.conv4_embed(feat1_4)
        pcl1_4, pcl1_4_to_2 = self.up_4_to_2(torch.cat((generated_data[3]['pc2_el_minus_gr'], feat1_4), dim=1),
                               in_barycentric=None,
                               in_lattice_offset=None,
                               blur_neighbors=generated_data[2]['pc2_blur_neighbors'], 
                               out_barycentric=generated_data[3]['pc2_barycentric'], 
                               out_lattice_offset=generated_data[3]['pc2_lattice_offset'], 
                               out_barycentric_upsample=generated_data[2]['pc2_barycentric'], 
                               out_lattice_offset_upsample=generated_data[2]['pc2_lattice_offset']
                              )
        pcl_corr_4_to_2 = self.coor_4_to_2(pcl0_4, pcl1_4, prev_corr_feat=None,
        ...
        pcl0_2, pcl0_2_to_1 = self.up_2_to_1(torch.cat((generated_data[2]['pc1_el_minus_gr'], pcl0_4_to_2, feat0_2), dim=1),
                               in_barycentric=None,
                               in_lattice_offset=None,
        ...
        pcl1_2, pcl1_2_to_1 = self.up_2_to_1(torch.cat((generated_data[2]['pc2_el_minus_gr'], pcl1_4_to_2, feat1_2), dim=1),
                               in_barycentric=None,
                               in_lattice_offset=None,
        ...
        pcl_corr_2_to_1 = self.coor_2_to_1(pcl0_2, pcl1_2, pcl_corr_4_to_2,
