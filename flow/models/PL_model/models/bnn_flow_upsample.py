...
class BilateralCorrelationFlex(nn.Module):
    ...
    def forward(self, feat1, feat2, prev_corr_feat,
                barycentric1, lattice_offset1, out_barycentric, out_lattice_offset,
        ...
        tmp_corr_blurred = corr_blurred[batch_indices[:, None, None, None],
        ...
        sliced = (out_barycentric[:, None, :, :] * tmp_corr_blurred).sum(dim=2)
