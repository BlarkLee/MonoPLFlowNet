...
class GenerateDataUnsymmetric(object):
    ...
    def __call__(self, pc1, pc2):
        ...
        with torch.no_grad():
            ...
            return pc1, pc2, generated_data_f#, generated_data_b
...
class ProcessData(object):
    ...
    def __call__(self, data, pcl_mask_gt):
        pc1, pc2 = data
        ...
        return pc1, pc2, maskall_1, maskall_2
...
class Augmentation(object):
    ...
    def __call__(self, data, pcl_mask_gt):
        ...
        #sf = sf[sampled_indices1]
        return pc1, pc2, sampled_indices1, sampled_indices2
