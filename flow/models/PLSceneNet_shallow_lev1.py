...
__all__ = ['PLSceneNet_shallow_lev1']
...
class PLSceneNet_shallow_lev1(nn.Module):
    def __init__(self, args): #, params, feat_out_channels, num_features=512):
        super(PLSceneNet_shallow_lev1, self).__init__()
    ...
    def forward(self, feat0_1, feat0_2, feat0_4, feat1_1, feat1_2, feat1_4, generated_data):  
        ...
        pcl0_1 = self.up_1_to_1(torch.cat((generated_data[1]['pc1_el_minus_gr'], feat0_1), dim=1),
                               in_barycentric=None,
        ...
        pcl1_1 = self.up_1_to_1(torch.cat((generated_data[1]['pc2_el_minus_gr'], feat1_1), dim=1),
                               in_barycentric=None,
                               in_lattice_offset=None,
        ...
        pcl_corr_1_to_1 = self.coor_1_to_1(pcl0_1, pcl1_1, prev_corr_feat=None,
