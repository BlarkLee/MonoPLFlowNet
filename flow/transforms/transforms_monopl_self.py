    ...
    def __call__(self, data):
        ...
        with torch.no_grad():
            ...
            for idx, (scale, bcn_filter_raidus, corr_filter_radius, corr_corr_radius) in enumerate(
                ...
                generated_data_f.append({'pc1_barycentric': pc1_barycentric,
            ...
            return pc1, pc2, generated_data_f
...
class ProcessData(object):
    ...
    def __call__(self, data):
        ...
        sf_f = sf_f[sampled_indices1]
        pc2 = pc2[sampled_indices2]
        return pc1, pc2, sf_f, sampled_indices1, sampled_indices2
