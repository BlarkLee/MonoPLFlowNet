...
def get_batch_2d_flow_monopl(pc1_gt, pc2_gt, predicted_pc1, predicted_pc2, paths):

    px1_gt, py1_gt = project_3d_to_2d(pc1_gt)
    px1_predicted, py1_predicted = project_3d_to_2d(predicted_pc1)
    px2_gt, py2_gt = project_3d_to_2d(pc2_gt)
    px2_predicted, py2_predicted = project_3d_to_2d(predicted_pc2)

    flow_x = px2_predicted - px1_predicted
    flow_y = py2_predicted - py1_predicted
